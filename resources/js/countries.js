...
const country_list_element_inner = document.querySelector(".country-list ul");
...
function createContryList(){
    ...
    list_item.id = country.name;
    list_item.innerHTML= country.name;
    list_item.setAttribute('onclick', `fetchData('${country.name}')`);  
    country_list_element_inner.appendChild(list_item);
});
} 
...
close_list_btn.addEventListener('click' , e =>{
    search_country_element.classList.toggle('hide');
    resetCountryList();
})
